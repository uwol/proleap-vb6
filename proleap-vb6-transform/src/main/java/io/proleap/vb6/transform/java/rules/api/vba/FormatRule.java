...
@Singleton
public class FormatRule extends VbTransformRule<ICS_S_MembersCallContext, MembersCall> {
	...
	public boolean where(final ICS_S_MembersCallContext ctx, final MembersCall membersCall, final RuleContext rc) {
		...
		pattern.addSubCall(new UndefinedCallImpl("Format", null, membersCall.getModule(), null, null));
