...
@Singleton
public class TimeRule extends VbTransformRule<ICS_S_VariableOrProcedureCallContext, Call> {
	...
	public boolean where(final ICS_S_VariableOrProcedureCallContext ctx, final Call call, final RuleContext rc) {
		final Call pattern = new UndefinedCallImpl("Time", null, call.getModule(), null, null);
