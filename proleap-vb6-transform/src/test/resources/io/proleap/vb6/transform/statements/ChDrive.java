...
public class Chdrive {
    static {
        ChDrive("C");                                                                                //   (1) ChDrive "C"
        String CurrentDrive = null;                                                                  //   (3) Dim CurrentDrive
        CurrentDrive="D";                                                                            //   (4) CurrentDrive = "D"
        ChDrive(CurrentDrive);                                                                       //   (5) ChDrive CurrentDrive
    }
}
